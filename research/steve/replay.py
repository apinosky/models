...
class ReplayBuffer(object):
    ...
    def __init__(self, max_size, obs_dim, action_dim, seed, roundrobin=True):
        ...
        self.next_action_buffer = np.zeros([max_size, action_dim])
    ...
    def random_batch(self, batch_size):
        ...
        return (
            ...
            self.next_action_buffer[indices],
            self.reward_buffer[indices],
            self.done_buffer[indices],
            self.count
        )

    def add_replay(self, obs, next_obs, action, next_action, reward, done):
    # def add_replay(self, obs, next_obs, action, reward, done):
        ...
        self.next_action_buffer[index] = next_action
    ...
    def save(self, path, name):
        ...
        fnames = [
            ...
            "%s/%s.next_action_buffer" % (path, name),
    ...
    def load(self, path, name):
        ...
        with open("%s/%s.next_action_buffer.npz" % (path,name)) as f: self.next_action_buffer = pickle.load(f)
